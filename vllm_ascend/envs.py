...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    # Explicit pure sparse-decode D-node marker. It selects the real sparse
    # residency requirement and the complete PD bootstrap admission contract.
    # Mutually exclusive with VLLM_ASCEND_LAYERWISE_PREFILL_P_NODE.
    "VLLM_ASCEND_DSA_SPARSE_DECODE_D_NODE": lambda: _strict_bool_env(
